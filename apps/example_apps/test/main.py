menu_name = "Hello World" #pyLCI needs this variable to show app name in the main menu
...
def init_app(input, output):
    """A function called once when pyLCI loads, to pass all the variables to the app"""
    global i, o
    i = input; o = output
